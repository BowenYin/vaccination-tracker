  ...
  <v-container>
    <v-row>
      <v-col cols="12">
        ...
        <h3>Data Sourcing</h3>
        <p>Vaccination data comes from the <a href="https://covid.cdc.gov/covid-data-tracker/#vaccinations" target="_blank">CDC</a>. Data on COVID-19 recoveries comes from the <a href="https://github.com/CSSEGISandData/COVID-19" target="_blank">COVID-19 Data Repository by the Center for Systems Science and Engineering (CSSE)</a> at Johns Hopkins University. The national number of recoveries is very underreported as not all states provide this information. Moreover, there is no standard metric for what a recovered patient is, and many states use different definitions.</p>
        <h2>About</h2>
